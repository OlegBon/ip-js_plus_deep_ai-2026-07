...
Документ описывает Prisma-схему Convertly Hub для PostgreSQL. Она зафиксирована миграциями `20260816094436_auth_features` и `20260822120000_finalize_schema`; последняя применена и проверена в локальном окружении.
