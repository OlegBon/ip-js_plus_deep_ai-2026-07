...
│
├── 📂 components/**/__tests__/# Unit-, component- и integration-тесты UI-функциональности
│
...
- Тесты располагаются рядом с компонентами в каталогах `__tests__` и покрывают загрузку файлов, аутентификацию, модальные окна, платежный сценарий, Dashboard и управление пользователями.
