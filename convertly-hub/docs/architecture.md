...
> **Статус на 22 августа 2026.** Документ описывает целевую архитектуру. В репозитории реализованы и протестированы frontend-прототип, Prisma-схема, `GET /api/health` и серверный S3-сервис; маршруты аутентификации, конвертации, API-ключей и администрирования ещё не реализованы. Поэтому UI кабинета и панели администратора сейчас использует mock-данные, а маршруты `(dashboard)` не защищены сессией.
