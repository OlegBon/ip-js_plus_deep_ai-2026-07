...
- **Модель данных (готова к миграции):** Prisma-схема описывает пользователей, API-ключи и журналы конвертаций, включая роли, статус блокировки, тариф, настройку хранения, S3-метаданные и жизненный цикл ключа. Серверные маршруты, использующие эти модели, ещё не реализованы.
