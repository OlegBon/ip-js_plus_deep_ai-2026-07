...
> В репозитории есть миграции RBAC/Telegram и тарифных квот. До настройки Telegram, назначения администратора или первой конвертации обязательно примените все миграции командой `npx prisma migrate deploy`, затем выполните `npx prisma generate`.
