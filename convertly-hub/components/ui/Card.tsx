...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={twMerge(clsx('rounded-lg border border-border bg-background text-text-primary shadow-sm', className))}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={twMerge(clsx('font-headings text-2xl font-semibold leading-none tracking-tight', className))}
    {...props}
  />
));
